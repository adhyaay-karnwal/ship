...
export function ComposerRepoSelector() {
  ...
  const triggerClass =
    'h-auto gap-0.5 px-0 py-0 rounded-full text-muted-foreground hover:text-foreground hover:bg-transparent! [&_span]:text-xs [&_span]:max-w-[200px] [&_svg]:size-2.5 [&_svg]:opacity-40 [&_svg]:transition-opacity hover:[&_svg]:opacity-100'
